// TODO: Move PageHeader to about this page tooltip
const PageHeader = () => (
  <p>
    ...
    example, a card with a win rate that is one standard deviation higher than
    the mean would get a B. Cards drawn fewer than 200 times are not included.
  </p>
);
